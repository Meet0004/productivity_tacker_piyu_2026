...
const ACTIVITY_CONFIG = {
  water:    { label: 'Water',    type: 'number',  color: '#60a5fa', icon: <Droplets     size={20} color='#60a5fa'/> },
  study:    { label: 'Study',    type: 'number',  color: '#f59e0b', icon: <Laptop     size={20} color='#f59e0b'/> },
  ...
  skincare: { label: 'Skincare',               type: 'boolean', color: '#60a5fa', icon: <ShowerHead size={20} color='#60a5fa' /> },
